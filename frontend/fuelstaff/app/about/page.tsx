            ...
            <Card>
              ...
              <Card.Body>
                ...
                <Card.Text>
                    ...
                    Introducing FuelStaff, the innovative food application specifically designed for hospital staff, created by Janine Soo Thow, a registered nurse with 
                    extensive experience in the healthcare industry. 
                
                    FuelStaff aims to revolutionize the way hospital employees access and enjoy their meals during hectic work shifts. Recognizing the challenges faced by hospital staff in finding nutritious food options
                    ...
                    With FuelStaff, hospital staff can now enjoy a wide range of healthy food choices conveniently delivered to them, eliminating the need to waste precious break time waiting in line. By encouraging 
                    ...
                    Recognizing the demanding nature of their job and the potential health risks that may arise from an unhealthy diet, FuelStaff provides easy access to balanced and wholesome meal options, reducing the 
